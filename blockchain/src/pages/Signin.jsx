...
<Grid container spacing={2} style={{padding:10}}>
  ...
  <br/>
    <Box sx={{width:'80%',marginLeft: '20px',border:'1px solid #124BF2', padding:'10px 20px', borderRadius:'20px', boxShadow: '0px 0px 18px 8px #124BF229'
}}>
  ...
  <br/><br/>
    ...
    }, backgroundColor:'#124bf2', color:'#ffffff', padding:'5px 45px', textTransform: 'capitalize', borderRadius:'50px', fontSize:'20px'}}>Log in</Button><br/><br/>
    </Box>
  </Grid>
</Grid>
