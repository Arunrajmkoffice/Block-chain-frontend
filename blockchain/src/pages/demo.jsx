...
function Addproduct() {
  ...
  return (
    ...
    {productnameError && ( <Typography variant="caption" sx={{ color: 'red'}}> Please enter a product name.</Typography>)}
    ...
    {batchNumberError && (<Typography variant="caption" sx={{ color: 'red' }}>Please enter a product Batch Number.</Typography>)}
    ...
    {skuError && (<Typography variant="caption" sx={{ color: 'red' }}> Please enter a product Sku.</Typography>)}</Box>
      <Box width='100%'>
